...
public class VipUser implements Serializable {
	private static final long serialVersionUID = 1222344428;
	...
	private List<ConsumptionRecord> records;//消费记录
	...
	public VipUser(Integer id, String name, Integer age, String telephone, Integer integrate, Integer level,
			Integer sex, Double money) {
		this.id = id;
		this.name = name;
		this.age = age;
